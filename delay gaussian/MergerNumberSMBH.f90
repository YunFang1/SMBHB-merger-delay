subroutine mergernumber(theta, params_galaxy, params_stellar, points_inner, points_outer, integration) 
    ...
    integer, intent(in)  :: points_inner, points_outer
    real(8), intent(out) :: integration
  
    integration = merger_number(theta, params_galaxy, params_stellar, points_inner, points_outer)
